...
/**
 * Parses raw spec content into a model and lists its operations.
 *
 * <p>Uses {@link OpenAPIParser}, which auto-detects the document type: OpenAPI 3.x is read
 * directly, while Swagger/OpenAPI 2.0 (<code>"swagger": "2.0"</code>) is transparently converted
 * to OpenAPI 3.0. Both YAML and JSON are accepted for either version.</p>
 */
@Service
